# cms-ars-5.0-aws-rds-crunchy-data-postgresql-stig-overlay

InSpec profile overlay to validate the secure configuration of AWS RDS hosted Crunchy Data PostgreSQL against [DISA's](https://iase.disa.mil/stigs/Pages/index.aspx) Crunchy Data PostgreSQL STIG Version 1, Release 1 (Applies to database versions 10, 11, 12 & 13) tailored for CMS ARS 5.0.
...
Against a remote aws rds target:

```bash
cinc-auditor exec https://github.com/cms-enterprise/cms-ars-5.0-aws-rds-crunchy-data-postgresql-stig-overlay/archive/main.tar.gz --input-file=<path_to_your_inputs_file/name_of_your_inputs_file.yml> --reporter=cli json:<path_to_your_output_file/name_of_your_output_file.json>
```
...
mkdir profiles
cd profiles
git clone https://github.com/cms-enterprise/cms-ars-5.0-aws-rds-crunchy-data-postgresql-stig-overlay.git
cinc-auditor archive cms-ars-5.0-aws-rds-crunchy-data-postgresql-stig-overlay
...
```
cd cms-ars-5.0-aws-rds-crunchy-data-postgresql-stig-overlay
git pull
cd ..
cinc-auditor archive cms-ars-5.0-aws-rds-crunchy-data-postgresql-stig-overlay --overwrite
cinc-auditor exec <name of generated archive> --input-file=<path_to_your_inputs_file/name_of_your_inputs_file.yml> --reporter=cli json:<path_to_your_output_file/name_of_your_output_file.json>
```
...
To report a bug or feature request, please open an [issue](https://github.com/cms-enterprise/cms-ars-5.0-aws-rds-crunchy-data-postgresql-stig-overlay/issues/new).
